...
train {
    ...
    step preprocess {
        image = "asia.gcr.io/span-production/workload-standard:v0.2.0-beta.4"
        install = [
        ...
        script = [
            {spark-submit {
                ...
                conf {
                    spark.kubernetes.container.image = "asia.gcr.io/span-production/workload-standard:v0.2.0-beta.4"
